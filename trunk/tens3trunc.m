function S = tens3trunc(s1,s2,s3,T)
...
% find location of indices in each column of T
a1 = find(ismember(T.I(:,1),u1));
a2 = find(ismember(T.I(:,2),u2));
a3 = find(ismember(T.I(:,3),u3));

% intersection is location of motifs
idx = intersect(intersect(a1,a2),a3);
S.I = T.I(idx,:);
S.V = T.V(idx);
S.dim = T.dim;
